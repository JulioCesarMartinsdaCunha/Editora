...
-- AUTOR
INSERT INTO editoradb.autor VALUES (NULL, "José Saramago", "Escritor português, vencedor do Prêmio Nobel de Literatura em 1998.", "1922-11-16");
INSERT INTO editoradb.autor VALUES (NULL, "Clarice Lispector", "Importante escritora brasileira conhecida por sua escrita introspectiva e existencialista.", "1920-12-10");
INSERT INTO editoradb.autor VALUES (NULL, "Machado de Assis", "Considerado um dos maiores escritores da literatura brasileira.", "1839-06-21");
INSERT INTO editoradb.autor VALUES (NULL, "Virginia Woolf", "Pioneira do modernismo literário e importante figura do feminismo.", "1882-01-25");
INSERT INTO editoradb.autor VALUES (NULL, "George Orwell", "Autor britânico famoso por obras como 1984 e A Revolução dos Bichos.", "1903-06-25");
INSERT INTO editoradb.autor VALUES (NULL, "J.K. Rowling", "Autora britânica conhecida mundialmente pela série Harry Potter.", "1965-07-31");
INSERT INTO editoradb.autor VALUES (NULL, "Gabriel García Márquez", "Escritor colombiano, vencedor do Nobel, expoente do realismo mágico.", "1927-03-06");
INSERT INTO editoradb.autor VALUES (NULL, "Franz Kafka", "Autor tcheco cujas obras influenciaram a literatura existencialista do século XX.", "1883-07-03");
INSERT INTO editoradb.autor VALUES (NULL, "Lygia Fagundes Telles", "Importante escritora brasileira, integrante da Academia Brasileira de Letras.", "1923-04-19");
INSERT INTO editoradb.autor VALUES (NULL, "Haruki Murakami", "Escritor japonês contemporâneo conhecido por suas narrativas surreais e introspectivas.", "1949-01-12");
...
INSERT INTO editoradb.livro (IDLIVRO, NOME, SINOPSE, ISBN, NUMERO_DE_PAGINAS, DATA_DE_PUBLICACAO, EXEMPLAR_idEXEMPLAR, AUTOR_idAUTOR, AREA_DE_CONHECIMENTO_idAREA_DE_CONHECIMENTO)
VALUES 
(NULL, "Ensaio Sobre a Cegueira", "Uma epidemia de cegueira repentina afeta uma cidade.", "9788535914849", 100, "1995-03-01", 1, 1, 1),
(NULL, "A Hora da Estrela", "História de Macabéa, uma nordestina no Rio de Janeiro.", "9788520927971", 120, "1977-10-25", 2, 1, 1),
(NULL, "Dom Casmurro", "Narrativa sobre amor e ciúmes, centrada em Bentinho e Capitu.", "9788535914840", 80, "1899-01-01", 3, 1, 1),
(NULL, "Mrs. Dalloway", "Um dia na vida de Clarissa Dalloway.", "9780141182490", 134, "1925-05-14", 4, 6, 9),
(NULL, "1984", "Distopia sobre vigilância e totalitarismo.", "9780451524935", 56, "1949-06-08", 5, 2, 2),
(NULL, "Harry Potter e a Pedra Filosofal", "Um garoto descobre que é bruxo.", "9788532511013", 76, "1997-06-26", 6, 1, 3),
(NULL, "Cem Anos de Solidão", "Saga da família Buendía em Macondo.", "9788535914843", 23, "1967-05-30", 7, 3, 3),
(NULL, "A Metamorfose", "Homem acorda transformado em inseto.", "9788582850146", 96, "1915-10-01", 8, 4, 4),
(NULL, "As Meninas", "Romance sobre a ditadura brasileira.", "9788535914841", 30, "1973-06-01", 9, 5, 9),
(NULL, "Kafka à Beira-Mar", "Dois personagens em jornadas paralelas no Japão.", "9788535902771", 49, "2002-09-12", 10, 8, 3);
